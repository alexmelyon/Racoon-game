...
{
    public GameObject level_preview_1;
    public GameObject level_preview_2;
    ...
    void Start()
    {
        ...
        for (int i = 3; i > stars1; i--)
            level_preview_1.GetComponentsInChildren<Transform>()[1].gameObject.SetActive(false);

        for (int i = 3; i > stars2; i--)
            level_preview_2.GetComponentsInChildren<Transform>()[1].gameObject.SetActive(false);
